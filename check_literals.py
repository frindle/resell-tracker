...
LITERALS = [[None, 'def POST(req):'], [None, '_scope_key(user_id, reserve_id, order_id)'], [None, '"retry window active"'], [None, '"not authenticated"'], [None, '"missing required fields: reserve_id, order_id"'], [None, 'RETRY_WINDOW_MS = 24 * 60 * 60 * 1000']]
