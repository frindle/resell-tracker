...
LITERALS = [[None, 'export function resolveStaleReservationLinkMigrations('], [None, 'bareLinkedRows: Array<{ id: number; reserveId: string | null; qty: number }>'], [None, 'liveUnlinkedRows: Array<{ id: number; reserveId: string | null; qty: number }>'], [None, 'Array<{ fromId: number; toId: number }>']]
