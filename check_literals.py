...
TARGET = pathlib.Path('app/orders/page.tsx')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, 'export function shouldShowNoReservationChip(o: Order): boolean {'], [None, '{shouldShowNoReservationChip(o) && ('], [None, '!o.cancelled && (o.bfmrLinks ?? []).length === 0 && !o.bfmrStatus && !o.salePriceSynced && /bfmr/i.test(']]
