...
TARGET = pathlib.Path('sidecar/src/loginQueue.js')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, "['amazon', 'walmart', 'costco']"], [None, 'activeSites'], [None, 'isEnabled'], [None, 'module.exports = { sitesNeedingLogin, runQueueOnce, activeSites, isEnabled };']]
