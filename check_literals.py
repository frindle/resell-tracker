...
TARGET = pathlib.Path('lib/emailSync.ts')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, 'host?: string'], [None, 'port?: number'], [None, 'secure?: boolean'], [None, 'mailbox?: string'], [None, "creds.host ?? 'imap.gmail.com'"], [None, 'creds.port ?? 993'], [None, 'creds.secure ?? true'], [None, "creds.mailbox ?? 'INBOX'"]]
