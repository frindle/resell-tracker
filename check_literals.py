...
LITERALS = [[None, 'export async function relinkStaleBfmrLinks'], [None, 'await relinkStaleBfmrLinks(userId, orderIds)'], [None, 'prisma.orderBfmrLink.update'], [None, 'recalcBfmrSalePrice'], [None, 'guardLink']]
