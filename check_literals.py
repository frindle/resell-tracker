...
LITERALS = [[None, 'export interface BfmrLinkLike {'], [None, 'reservationTracking?: string | null;'], [None, 'export function selectCanonicalBfmrLinks<T extends BfmrLinkLike>(links: T[]): T[]'], [None, 'normalize(l.reservationTracking)']]
