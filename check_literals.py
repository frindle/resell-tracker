...
TARGET = pathlib.Path('prisma/schema.prisma')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, 'model SavedAddress'], [None, 'retailer'], [None, 'addressKey'], [None, '@unique'], [None, 'line1'], [None, 'updatedAt'], [None, '@updatedAt']]
