...
TARGET = pathlib.Path('app/page.tsx')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, 'unsubmittedCCFilter'], [None, '{ NOT: { AND: [{ giftCards: { some: {} } }, { giftCards: { every: { ccSubmittedAt: null } } }] } }'], [None, '...unsubmittedCCFilter, orderDate:']]
