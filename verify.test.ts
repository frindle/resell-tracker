// Adversarial repo-style test for: amazon-iris-frame-diagnosis   (node --test / tsx --test)
//
...
//   import { theFn } from './sidecar/src/amazon';      // relative
...
// import { theFn } from './sidecar/src/amazon';   // <-- wire this to the real symbol
