// Adversarial repo-style test for: orders-row-spacing   (node --test / tsx --test)
//
...
//   import { theFn } from './app/layout';      // relative
...
// import { theFn } from './app/layout';   // <-- wire this to the real symbol
