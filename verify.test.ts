// Adversarial repo-style test for: rt-costco-always-sites-s1-loginqueue-js-near-lines   (node --test / tsx --test)
//
...
//   import { theFn } from './sidecar/src/loginQueue';      // relative
...
// import { theFn } from './sidecar/src/loginQueue';   // <-- wire this to the real symbol
