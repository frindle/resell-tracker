// Adversarial repo-style test for: amazon-card-nomatch-diagnosis   (node --test / tsx --test)
//
...
//   import { theFn } from './prisma/schema.prisma';      // relative
...
// import { theFn } from './prisma/schema.prisma';   // <-- wire this to the real symbol
