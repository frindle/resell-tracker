// Adversarial repo-style test for: cc-waitlist-r2-s1-build-a-card-center-gift   (node --test / tsx --test)
//
...
//   import { theFn } from './lib/ccWaitlist';      // relative
...
// import { theFn } from './lib/ccWaitlist';   // <-- wire this to the real symbol
