...
- `test_fixture.py`: CASES (const), main (def)
...
- `test_fixture.py:28` -> `# ("count=1 is under the threshold", lambda: target.is_safe({"count": 1}, True), False),`
- `test_fixture.py:45` -> `fails += 1`
- `test_fixture.py:49` -> `fails += 1`
