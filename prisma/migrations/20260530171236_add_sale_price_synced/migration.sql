...
INSERT INTO "new_Order" ("buyerId", "cardId", "cashbackAmount", "cost", "createdAt", "id", "itemDescription", "notes", "orderDate", "orderNumber", "platform", "salePrice", "shippingAddress", "shippingCost", "sourceUrl", "updatedAt", "userId") SELECT "buyerId", "cardId", "cashbackAmount", "cost", "createdAt", "id", "itemDescription", "notes", "orderDate", "orderNumber", "platform", "salePrice", "shippingAddress", "shippingCost", "sourceUrl", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
