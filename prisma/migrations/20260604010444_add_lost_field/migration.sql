...
INSERT INTO "new_Order" ("bgExpectedPayout", "bgPaidAmount", "buyerId", "cardId", "cashbackAmount", "cost", "createdAt", "id", "ignoredByRule", "itemDescription", "notes", "orderDate", "orderNumber", "overdueAt", "platform", "salePrice", "salePriceSynced", "shippingAddress", "shippingCost", "skipAddressBlock", "sourceUrl", "trackingNumbers", "trackingSubmittedToBg", "updatedAt", "userId") SELECT "bgExpectedPayout", "bgPaidAmount", "buyerId", "cardId", "cashbackAmount", "cost", "createdAt", "id", "ignoredByRule", "itemDescription", "notes", "orderDate", "orderNumber", "overdueAt", "platform", "salePrice", "salePriceSynced", "shippingAddress", "shippingCost", "skipAddressBlock", "sourceUrl", "trackingNumbers", "trackingSubmittedToBg", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
